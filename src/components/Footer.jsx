  ...
  return (
    <footer className=" pt-16 pb-8 px-4 relative border-t border-border">
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-start md:items-center gap-8">
        ...
        <div className="flex  items-center md:items-start"
          ...
          <div className="flex flex-col items-center md:items-start gap-2 mr-6 p-4">
            <h2 className="text-2xl font-semibold text-white">Heng Vanreuth</h2>
          ...
          <div>
            <div className="flex flex-col md:flex-row gap-8">
              <div>
                ...
                <a
                  href="mailto:rornsokhengnaa@gmail.com"
      ...
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-4">
        ...
        <a
          href="#hero"
          className="fixed bottom-8 right-8 p-4 rounded-full bg-black text-white hover:bg-primary transition-colors shadow-lg z-50"
        >
          <ArrowUp size={28} />
        </a>
      </div>
